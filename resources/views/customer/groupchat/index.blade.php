    ...
    <div class="group-chat-container customer-trainingcenter-group-chat-container">
        ...
        <div id = "media">
            ...
            <div class="group-chat-media-container customer-trainingcenter-media-container">
                ...
                <div class="modal fade" id="exampleModalToggle{{$media->id}}" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <video class="w-100" controls>
                                <source src="{{asset('/storage/trainer_message_media/'.$media->media)}}" type="video/mp4">
                              Your browser does not support the video tag.
                          </video>
                            @else
                             <img src="{{asset('/storage/trainer_message_media/'.$media->media)}}" alt="test" class="w-100">
                            @endif
                        </div>
                      </div>
                    </div>
